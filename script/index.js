...
function displayCards(issues) {
    ...
    container.innerHTML = issues.map(issue => {
        ...
        return `
            <div onclick="openIssueDetail('${issue._id}')" class="bg-white rounded-lg shadow-sm p-5 cursor-pointer hover:shadow-md transition border border-gray-100 ${borderClass} flex flex-col h-full">
                <div class="flex justify-between items-center mb-4">
                    <span class="p-1.5 bg-gray-50 rounded-full">🟢</span>
...
// 5. Modal Display (Screenshot 3 style)
